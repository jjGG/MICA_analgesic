...
#
#  Start with reading in data and annotation
#
...
# data
#dataFileName <- "data_close2final_MICA_2024-07-03.txt"
dataFileName <- "data_close2final_MICA_2025-10-30_remove3.txt"
...
write_tsv(x = gg, file = "pMica_complicationsTable_2025-10-30.tsv")
...
dim(resultColsOI)
write_tsv(resultColsOI, file = "Analgetic_intake_2025-10-30.tsv")
write_tsv(relevantDat[,c(grep(x = colnames(relevantDat), pattern = "txtcom") )], file = "ShortWay_complications_2025-10-30.tsv")
...
# write out results
write.table(moreRes, file = "PrePost_DMAA_2025-10-30.tsv", sep="\t", quote = FALSE)
...
#
########
# August 2024 -> issue here .. we do not need it anymore
...
# filtering!!
write.table(finalDF, file = "Dataframe_finalDF_withSubclasses_2025-10-30.txt", sep="\t", quote = FALSE)
...
pdf("HV-pre-post_2025-10-30.pdf")
...
pdf("IMA-pre-post_2025-10-30.pdf")
boxplot(as.numeric(ddf[,1]), as.numeric(ddf[,2]))
legend("topright", paste("pValue: ",round(pV,6)))
dev.off()
...
pdf("DMAA-pre-post_2025-10-30.pdf")
boxplot(lastCOI2, lastCOI3)
legend("topright", paste("pValue: ",round(pV,6)))
dev.off()
...
pdf("AOFAS-pre-post_2025-10-30.pdf")
...
pdf("MOXFQ-pre-post_2025-10-30.pdf")
...
pdf("MOXFQsubSocial interaction-pre-post_2025-10-30.pdf")
...
pdf("MOXFQsubwalkingNstanding interaction-pre-post_2025-10-30.pdf")
boxplot(as.numeric(ddf[,1]), as.numeric(ddf[,6]))
legend("topright", paste("pValue: ",round(pV,6)))
dev.off()
...
pdf("MOXFQsubPain interaction-pre-post_2025-10-30.pdf")
boxplot(as.numeric(ddf[,1]), as.numeric(ddf[,6]))
legend("topright", paste("pValue: ",round(pV,6)))
dev.off()
...
pdf("FFI-pre-post_2025-10-30.pdf")
...
pdf("FFIsubScales disability interaction-pre-post_2025-10-30.pdf")
boxplot(as.numeric(ddf[,1]), as.numeric(ddf[,6]))
legend("topright", paste("pValue: ",round(pV,6)))
dev.off()
...
pdf("FFIsubScales difficulty interaction-pre-post_2025-10-30.pdf")
boxplot(as.numeric(ddf[,1]), as.numeric(ddf[,6]))
legend("topright", paste("pValue: ",round(pV,6)))
dev.off()
...
pdf("FFIsubScales pain interaction-pre-post_2025-10-30.pdf")
...
pdf("EQVAS-pre-post_2025-10-30.pdf")
...
pdf("EQ5D5L-pre-post_2025-10-30.pdf")
...
save(finalIncluded, file = "FinalVariablesForRegression_2025-10-30.RData")
...
# write out results
write.table(myResults, file = "myResults_MICA_MeanSDnMore_allIncluded_wPreop_2025-10-30.txt", sep="\t", quote = FALSE)
...
# some plotting
pdf("MyPairs_allNumeric_2025-10-30.pdf",30,30)
...
pdf("MyPairs_allNumeric_2025-10-30_fix1_betterRead.pdf",20,20)
# pairs(final_bado, lower.panel = Michipanel.cor, cex.cor = 1, pch="x")
pairs(finalIncluded_okForPlotting[,3:ncol(finalIncluded_okForPlotting)],lower.panel = Michipanel.cor, cex.cor = 1, pch="x")
dev.off()
...
pdf("recommendation_2025-10-30.pdf", 8,8)
# Plot histogram
...
pdf("satisfaction_2025-10-30.pdf", 8,8)
# Plot histogram
